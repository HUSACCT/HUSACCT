...
public class UiDialogs {
     ...
     * 
     * @param component
     *            The component where the dialog needs to hover above
     * @param message
     *            The message
     * @param title
     *            The title of the dialog
     */
    public static boolean confirmDialog(Component component, String message,
	    String title) {
    ...
    /**
     * Method which will show an inputdialog. The dialog keeps asking for input
		...
		if (!inputValue.trim().equals("")) {
		    ...
		    errorDialog(component,
			    ServiceProvider.getInstance().getLocaleService()
				    .getTranslatedString("MissingValue"));
		}
	    }
	}
	return inputValue;
