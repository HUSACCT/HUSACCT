...
public class JPanelStatus extends JPanel {
    ...
    private String defaultMessage = ServiceProvider.getInstance()
	    .getLocaleService().getTranslatedString("IdleMessage");
	...
	add(jProgressBar, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
		GridBagConstraints.FIRST_LINE_START, GridBagConstraints.BOTH,
		new Insets(0, 0, 0, 0), 0, 0));
