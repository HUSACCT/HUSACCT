...
public void changeColumnHeaders() {
	this.getTableHeader().getColumnModel().getColumn(0).setHeaderValue("Description");
	this.getTableHeader().getColumnModel().getColumn(1).setHeaderValue("Resource");
	this.getTableHeader().getColumnModel().getColumn(2).setHeaderValue("Location");
	this.getTableHeader().getColumnModel().getColumn(3).setHeaderValue("Type");
}
