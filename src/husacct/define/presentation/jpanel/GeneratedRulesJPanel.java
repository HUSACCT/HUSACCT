...
public class GeneratedRulesJPanel extends JPanel  implements ActionListener, Observer, IServiceListener {
	...
	private JButton approveRuleButton;

	public GeneratedRulesJPanel() {
		super();
	}
	...
	public void initGui() {
		...
		this.setBorder(BorderFactory.createTitledBorder(ServiceProvider.getInstance().getLocaleService().getTranslatedString("GeneratedRules")));
	...
	protected JPanel addButtonPanel() {
		...
		approveRuleButton = new JButton();
		buttonPanel.add(approveRuleButton, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		approveRuleButton.addActionListener(this);
	...
	public void actionPerformed(ActionEvent action) {
		if (action.getSource() == this.approveRuleButton) {
			this.approveRule();
		} 
	}
	...
	{
		//Voeg de regel toe aan de defined/custom rules.
	}
	...
	private void enableButtons() {
		approveRuleButton.setEnabled(true);
	}

	private void disableButtons() {
		approveRuleButton.setEnabled(false);
	}
	...
	private void setButtonTexts() {
		approveRuleButton.setText(ServiceProvider.getInstance().getLocaleService().getTranslatedString("ApproveRule"));
	}
}
