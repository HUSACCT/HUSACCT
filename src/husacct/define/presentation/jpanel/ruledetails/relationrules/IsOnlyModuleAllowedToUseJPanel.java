...
public class IsOnlyModuleAllowedToUseJPanel extends AbstractDetailsJPanel {
    public static final String ruleTypeKey = "IsOnlyModuleAllowedToUse";
    ...
    public IsOnlyModuleAllowedToUseJPanel(
