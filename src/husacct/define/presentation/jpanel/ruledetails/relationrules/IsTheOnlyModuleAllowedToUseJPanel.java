package husacct.define.presentation.jpanel.ruledetails.relationrules;
...
public class IsTheOnlyModuleAllowedToUseJPanel extends AbstractDetailsJPanel {
    public static final String ruleTypeKey = "IsTheOnlyModuleAllowedToUse";
    private static final long serialVersionUID = -3235785454278218005L;
    ...
    public IsTheOnlyModuleAllowedToUseJPanel(
