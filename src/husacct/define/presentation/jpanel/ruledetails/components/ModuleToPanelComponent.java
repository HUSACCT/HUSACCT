...
public class ModuleToPanelComponent extends AbstractPanelComponent implements
	...
	moduleToTree = new CombinedModuleTree(rootComponent,
	...
	moduleToJLabel = new JLabel(ServiceProvider.getInstance()
		.getLocaleService().getTranslatedString("ToModule"));
