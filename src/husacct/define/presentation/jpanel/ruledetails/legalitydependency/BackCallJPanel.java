...
public class BackCallJPanel extends AbstractDetailsJPanel implements TreeSelectionListener{
	...
	public BackCallJPanel(AppliedRuleController appliedRuleController) {
