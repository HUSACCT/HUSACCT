...
public class ExternalSystemFigure extends BaseFigure {
	...
	public static final Color ExternalLibBackgroundColor = new Color(141, 188, 235);

	public ExternalSystemFigure(String name) {
		super(name);
	...
	@Override
	public ExternalSystemFigure clone() {
		ExternalSystemFigure other = (ExternalSystemFigure) super.clone();
