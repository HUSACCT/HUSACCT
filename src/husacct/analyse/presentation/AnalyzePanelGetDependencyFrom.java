...
public class AnalyzePanelGetDependencyFrom extends JInternalFrame implements TreeSelectionListener{  
	...
	public AnalyzePanelGetDependencyFrom(){
		setFrameSettings();
		addComponents();
	...
	private void addComponents() {
	    ...
	    JInternalFrame internalFrame = new JInternalFrame("Select Package/Class (From Tree)", true, true, true, true); 
	    ...
	    internalFrame2 = new JInternalFrame("Dependency View - Service Input (From)", true, true, true, true);
	...
	private void setFrameSettings(){ 
		...
		this.setTitle("Service - Get Dependency's From");
	...
	public void valueChanged(TreeSelectionEvent eventTree) {
    	...
    	DependencyDTO[] dependencysPerName = analyseService.getDependenciesFrom(nodeData);
    	...
    	{
    	 	model.setRowCount(0);
    		model.addRow(new Object[]{"No Dependency's Found From =>", nodeData});  
    	 }
