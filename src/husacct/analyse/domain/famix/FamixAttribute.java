...
class FamixAttribute extends FamixStructuralEntity {
    ...
    public boolean multipleValues; 		// False if the type allows one value only, like Person; True in case of a generic type, or e.g. Person[]. 
    ...
    public String toString() {
        ...
        importRepresentation += "\nmultipleValues: " + multipleValues + ", typeInClassDiagram: " + typeInClassDiagram;
        importRepresentation += "\n";
        importRepresentation += "\n";
