...
import husacct.analyse.infrastructure.antlr.java.Java7Parser.FormalParameterListContext;
...
public class ParameterAnalyser extends JavaGenerator {
    ...
    private void setTypeAndAddToQue(TypeTypeContext typeType) {
        this.declareType = determineTypeOfTypeType(typeType, belongsToClass, DependencySubTypes.DECL_PARAMETER);
