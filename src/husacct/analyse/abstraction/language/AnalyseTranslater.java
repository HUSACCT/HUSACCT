package husacct.analyse.abstraction.language;
...
public class AnalyseTranslater {
	
	private static final String bundleLocation = "husacct.common.locale.analyseLang";
	private static Logger logger = Logger.getLogger(AnalyseTranslater.class);
