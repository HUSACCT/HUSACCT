...
public class JavaLexer extends Lexer {
     ...
     *
     * If
     * <code>true</code> whitespaces and comments will be preserved within the
    ...
    public final void mHEX_LITERAL() throws RecognitionException {
        try {
            ...
            // :1083:15: '0' ( 'x' | 'X' ) ( HEX_DIGIT )+ ( INTEGER_TYPE_SUFFIX )?
            {
                ...
                switch (alt2) {
                    case 1: // :1083:40: INTEGER_TYPE_SUFFIX
                    {
    ...
    public final void mDECIMAL_LITERAL() throws RecognitionException {
        try {
            ...
            // :1085:19: ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( INTEGER_TYPE_SUFFIX )?
            {
                ...
                switch (alt5) {
                    case 1: // :1085:46: INTEGER_TYPE_SUFFIX
                    {
                        mINTEGER_TYPE_SUFFIX();
    ...
    public final void mOCTAL_LITERAL() throws RecognitionException {
        try {
            ...
            // :1087:17: '0' ( '0' .. '7' )+ ( INTEGER_TYPE_SUFFIX )?
            {
                ...
                switch (alt7) {
                    case 1: // :1087:33: INTEGER_TYPE_SUFFIX
                    {
                        mINTEGER_TYPE_SUFFIX();
    ...
    public final void mFLOATING_POINT_LITERAL() throws RecognitionException {
        try {
            ...
            switch (alt17) {
                case 1: // :1096:9: ( '0' .. '9' )+ ( DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )? | EXPONENT ( FLOAT_TYPE_SUFFIX )? | FLOAT_TYPE_SUFFIX )
                {
                    // :1096:9: ( '0' .. '9' )+
                    int cnt8 = 0;
                    loop8:
                    ...
                    switch (alt13) {
                        case 1: // :1098:13: DOT ( '0' .. '9' )* ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )?
                        {
                            mDOT();
                            // :1098:17: ( '0' .. '9' )*
                            loop9:
                            ...
                            switch (alt11) {
                                case 1: // :1098:39: FLOAT_TYPE_SUFFIX
                                {
                                    mFLOAT_TYPE_SUFFIX();
                        ...
                        break;
                        case 2: // :1099:13: EXPONENT ( FLOAT_TYPE_SUFFIX )?
                        {
                            mEXPONENT();
                            ...
                            switch (alt12) {
                                case 1: // :1099:22: FLOAT_TYPE_SUFFIX
                                {
                                    mFLOAT_TYPE_SUFFIX();
                        ...
                        break;
                        case 3: // :1100:13: FLOAT_TYPE_SUFFIX
                        {
                            mFLOAT_TYPE_SUFFIX();
                ...
                break;
                case 2: // :1102:9: DOT ( '0' .. '9' )+ ( EXPONENT )? ( FLOAT_TYPE_SUFFIX )?
                {
                    mDOT();
                    // :1102:13: ( '0' .. '9' )+
                    int cnt14 = 0;
                    ...
                    switch (alt16) {
                        case 1: // :1102:35: FLOAT_TYPE_SUFFIX
                        {
                            mFLOAT_TYPE_SUFFIX();
    ...
    public final void mCHARACTER_LITERAL() throws RecognitionException {
        try {
            ...
            // :1112:9: '\\'' ( ESCAPE_SEQUENCE | ~ ( '\\'' | '\\\\' ) ) '\\''
            {
                ...
                switch (alt20) {
                    case 1: // :1112:16: ESCAPE_SEQUENCE
                    {
                        mESCAPE_SEQUENCE();
        ...
        try {
            ...
            // :1116:8: '\"' ( ESCAPE_SEQUENCE | ~ ( '\\\\' | '\"' ) )* '\"'
            {
                ...
                do {
                    ...
                    switch (alt21) {
                        case 1: // :1116:14: ESCAPE_SEQUENCE
                        {
                            mESCAPE_SEQUENCE();
    ...
    public final void mESCAPE_SEQUENCE() throws RecognitionException {
        try {
            ...
            switch (alt22) {
                ...
                break;
                case 2: // :1122:9: UNICODE_ESCAPE
                {
                    mUNICODE_ESCAPE();

                }
                break;
                case 3: // :1123:9: OCTAL_ESCAPE
                {
                    mOCTAL_ESCAPE();
    ...
    public void mTokens() throws RecognitionException {
        ...
        switch (alt28) {
            ...
            break;
            case 5: // :1:35: BIT_SHIFT_RIGHT
            {
                mBIT_SHIFT_RIGHT();

            }
            break;
            case 6: // :1:51: BIT_SHIFT_RIGHT_ASSIGN
            {
            ...
            break;
            case 13: // :1:109: DOTSTAR
            {
                mDOTSTAR();

            }
            break;
            case 14: // :1:117: ELLIPSIS
            {
                mELLIPSIS();
            ...
            break;
            case 16: // :1:132: GREATER_OR_EQUAL
            {
                mGREATER_OR_EQUAL();

            }
            break;
            case 17: // :1:149: GREATER_THAN
            {
                mGREATER_THAN();
            ...
            break;
            case 19: // :1:166: LBRACK
            {
                mLBRACK();

            }
            break;
            case 20: // :1:173: LCURLY
            {
                mLCURLY();

            }
            break;
            case 21: // :1:180: LESS_OR_EQUAL
            {
                mLESS_OR_EQUAL();

            }
            break;
            case 22: // :1:194: LESS_THAN
            {
                mLESS_THAN();

            }
            break;
            case 23: // :1:204: LOGICAL_AND
            {
                mLOGICAL_AND();

            }
            break;
            case 24: // :1:216: LOGICAL_NOT
            {
                mLOGICAL_NOT();

            }
            break;
            case 25: // :1:228: LOGICAL_OR
            {
                mLOGICAL_OR();

            }
            break;
            case 26: // :1:239: LPAREN
            {
                mLPAREN();
            ...
            break;
            case 36: // :1:312: PLUS_ASSIGN
            {
                mPLUS_ASSIGN();

            }
            break;
            case 37: // :1:324: QUESTION
            {
                mQUESTION();

            }
            break;
            case 38: // :1:333: RBRACK
            {
                mRBRACK();

            }
            break;
            case 39: // :1:340: RCURLY
            {
                mRCURLY();

            }
            break;
            case 40: // :1:347: RPAREN
            {
                mRPAREN();
            ...
            break;
            case 42: // :1:359: SHIFT_LEFT
            {
                mSHIFT_LEFT();

            }
            break;
            case 43: // :1:370: SHIFT_LEFT_ASSIGN
            {
                mSHIFT_LEFT_ASSIGN();

            }
            break;
            case 44: // :1:388: SHIFT_RIGHT
            {
                mSHIFT_RIGHT();

            }
            break;
            case 45: // :1:400: SHIFT_RIGHT_ASSIGN
            {
                mSHIFT_RIGHT_ASSIGN();
            ...
            break;
            case 49: // :1:440: XOR_ASSIGN
            {
                mXOR_ASSIGN();

            }
            break;
            case 50: // :1:451: ABSTRACT
            {
                mABSTRACT();

            }
            break;
            case 51: // :1:460: ASSERT
            {
                mASSERT();

            }
            break;
            case 52: // :1:467: BOOLEAN
            {
                mBOOLEAN();
            ...
            break;
            case 59: // :1:508: CONTINUE
            {
                mCONTINUE();

            }
            break;
            case 60: // :1:517: DEFAULT
            {
                mDEFAULT();
            ...
            break;
            case 72: // :1:586: IMPLEMENTS
            {
                mIMPLEMENTS();

            }
            break;
            case 73: // :1:597: INSTANCEOF
            {
                mINSTANCEOF();

            }
            break;
            case 74: // :1:608: INTERFACE
            {
                mINTERFACE();

            }
            break;
            case 75: // :1:618: IMPORT
            {
                mIMPORT();
            ...
            break;
            case 81: // :1:650: PACKAGE
            {
                mPACKAGE();

            }
            break;
            case 82: // :1:658: PRIVATE
            {
                mPRIVATE();

            }
            break;
            case 83: // :1:666: PROTECTED
            {
                mPROTECTED();

            }
            break;
            case 84: // :1:676: PUBLIC
            {
                mPUBLIC();

            }
            break;
            case 85: // :1:683: RETURN
            {
                mRETURN();
            ...
            break;
            case 87: // :1:696: STATIC
            {
                mSTATIC();

            }
            break;
            case 88: // :1:703: STRICTFP
            {
                mSTRICTFP();
            ...
            break;
            case 90: // :1:718: SWITCH
            {
                mSWITCH();

            }
            break;
            case 91: // :1:725: SYNCHRONIZED
            {
                mSYNCHRONIZED();
            ...
            break;
            case 94: // :1:749: THROWS
            {
                mTHROWS();

            }
            break;
            case 95: // :1:756: TRANSIENT
            {
                mTRANSIENT();
            ...
            break;
            case 99: // :1:780: VOLATILE
            {
                mVOLATILE();

            }
            break;
            case 100: // :1:789: WHILE
            {
                mWHILE();

            }
            break;
            case 101: // :1:795: HEX_LITERAL
            {
                mHEX_LITERAL();

            }
            break;
            case 102: // :1:807: DECIMAL_LITERAL
            {
                mDECIMAL_LITERAL();

            }
            break;
            case 103: // :1:823: OCTAL_LITERAL
            {
                mOCTAL_LITERAL();

            }
            break;
            case 104: // :1:837: FLOATING_POINT_LITERAL
            {
                mFLOATING_POINT_LITERAL();

            }
            break;
            case 105: // :1:860: CHARACTER_LITERAL
            {
                mCHARACTER_LITERAL();

            }
            break;
            case 106: // :1:878: STRING_LITERAL
            {
                mSTRING_LITERAL();

            }
            break;
            case 107: // :1:893: IDENT
            {
                mIDENT();
            ...
            break;
            case 109: // :1:902: COMMENT
            {
                mCOMMENT();

            }
            break;
            case 110: // :1:910: LINE_COMMENT
            {
                mLINE_COMMENT();
